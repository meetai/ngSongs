...
export class YoutubeApiService {
  ...
  searchVideos(query: string): Promise<any> {
    ...
    const url = `${this.base_url}playlistItems?type=video&maxResults=${this.max_results}&part=snippet,id&playlistId=UUyyQIyTxIOyLh01z7lpafhQ&videoEmbeddable=true&key=${YOUTUBE_API_KEY}`;
// console.log(url);
